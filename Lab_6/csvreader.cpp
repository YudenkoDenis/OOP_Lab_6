...
AbstractReader& CSVReader::operator>> (Lesson &l){
    ...
    if (fin.is_open() && !fin.eof()) {
        ...
        l.number = stoi(v[0]); //преобразование целочисленного типа в строку
        l.nameLes = QString::fromStdString(v[1]);
        l.type = QString::fromStdString(v[2]);
        l.auditorium = stoi(v[3]);
        }
